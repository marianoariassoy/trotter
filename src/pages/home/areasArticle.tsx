  ...
  return (
    <article className='flex flex-col gap-y-8 lg:gap-y-12'>
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
        ...
        <div className='aspect-[7/5] rounded-4xl overflow-hidden'>
          <Image
            src={image}
            alt={title}
          />
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-2'>
        {items.map((item, index) => (
          <div
            className='rounded-3xl px-6 py-6 lg:p-8 flex flex-col gap-y-2 bg-gradient-to-b from-primary   to-primary/30'
            key={index}
          >
