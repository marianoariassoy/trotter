const porque = ({ lan }: { lan: string }) => {
  return (
    <section className='h-[30vh] lg:h-[50vh] flex justify-center items-center relative bg-[url("/assets/bg-social.svg")] bg-cover lg:bg-contain bg-center bg-no-repeat'>
