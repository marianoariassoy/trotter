const hora = ({ lan }: { lan: string }) => {
  return (
    <section
      className='min-h-screen py-30 bg-[url("/assets/hero_bg.webp")] bg-cover bg-no-repeat flex items-center justify-center px-4 relative bg-[center_50%]'
      id='home'
    >
      <div className='absolute inset-0 bg-gradient-to-b from-white/50 via-transparent to-white'></div>;
      <div className='relative z-10 max-w-4xl m-auto flex flex-col gap-y-8 lg:gap-y-12 items-center justify-center text-center px-8'>
        ...
        <div className='font-medium lg:text-lg m-auto whitespace-break-spaces'>
          {lan === 'en'
